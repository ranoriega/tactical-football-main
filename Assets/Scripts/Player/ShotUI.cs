...
public class ShotUI : MonoBehaviour
{
    ...
    public void OpenShotMenu(Transform player)
    {
        shooter = player;
    ...
    private void SelectShotLocal(Vector3 localOffset)
    {
        ...
        var action = shooter.GetComponent<PlayerActionQueue>();
        if (action == null)
        {
       ...
       action.RegisterShot(shooter,localOffset);
